    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_ru', models.CharField(max_length=200, verbose_name='Название категории (РУ)')),
                ('name_az', models.CharField(max_length=200, verbose_name='Название категории (АЗ)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='shopAviato.category', verbose_name='Категория')),
